...
#                    os.system('dd if=/dev/urandom of=/dev/mtd0 bs=10000 count=1')
#                    os.system('dd if=/dev/urandom of=/dev/mtd2 bs=10000 count=1')
#                    os.system('dd if=/dev/urandom of=/dev/mtd4 bs=10000 count=1')
