...
#            from EGAMI.EGAMI_tools import readEmuName
#            readEmuName()
...
#               cmd = ';rm /tmp/Addon.tgz;wget -q http://enigma-spark.com/egami/softcams_cfg/wicardd_115_egami_E2.tar.gz -O /tmp/Addon.tgz'
