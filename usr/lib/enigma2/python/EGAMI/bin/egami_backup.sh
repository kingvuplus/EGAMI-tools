...
if [ -f /proc/stb/info/boxtype ] ; then
	if [ "$(cat /proc/stb/info/boxtype)" == 'ini-9000ru' ]; then
		...
		MODEL=5x00
		MTD=mtd2
	elif [ "$(cat /proc/stb/info/boxtype)" == 'ini-2000am' ]; then
		TYPE=atemio
		MTD=mtd2
		if [ -f /usr/share/enigma2/atemio6000.jpg ] ; then
			MODEL=6000
		elif [ -f /usr/share/enigma2/atemio6100.jpg ]; then
			MODEL=6100
		elif [ -f /usr/share/enigma2/atemio6200.jpg ]; then
			MODEL=6200
		else
			MODEL=6x00
		fi
