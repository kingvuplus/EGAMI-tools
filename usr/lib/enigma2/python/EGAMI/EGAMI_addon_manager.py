...
class EGAddonMenu(Screen):
    ...
    def updateList(self):
        ...
        self.list = []
        self.list.append(EgamiAddonMenuEntryComponent('Download EGAMI Addons', _('Download from feed IPTV, Plugin Multimidia And Other'), _('Collection of nice IPTV plugins, bootlogos and Plugins Multimidia'), 'addons/addon_download'))
